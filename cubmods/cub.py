...
Example1:
    ...
    sample.save("tesi_test_cub")
    # stampa a video del riassunto
    print(sample.summary())
    # produzione del grafico di default
    # e salvataggio come file png
    sample.plot(saveas="tesi_test_cub.png")
    plt.show()
...
Example2:
    ...
    sample = load_object("tesi_test_cub.cub.sample")
    ...
    # produzione del grafico di default
    # e salvataggio come file png
    fit.plot(saveas="tesi_test_cub_fit.png")
    plt.show()
    sample.as_dataframe().to_csv("tesi_test_cub.csv")
