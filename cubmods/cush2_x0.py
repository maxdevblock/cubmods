...
============
    ...
    *Modelli della classe CUB in Python*.
    ...
    :math:`\Pr(R_i=r|\pmb \theta;\pmb x_{1i}) = \delta_{1i} D_r^{(c_1)} + \delta_2 D_r^{(c_2)} + (1 - \delta_{1i} - \delta_2)/m`
...
def pmfi(m, sh1, sh2,
    ...
    :math:`\Pr(R = r | \pmb\theta_i ; \pmb x_{1i}),\; i=1 \ldots n ,\; r=1 \ldots m`
...
def pmf(m, sh1, sh2,
    ...
    :math:`\frac{1}{n} \sum_{i=1}^n \Pr(R = r | \pmb\theta_i ; \pmb x_{1i}),\; r=1 \ldots m`
